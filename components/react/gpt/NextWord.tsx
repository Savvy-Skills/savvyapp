...
import { nextWordPrediction } from "@/services/mediaAPI";
...
export default function GPTNextWordGame() {
	...
	const handlePredict = useCallback(async () => {
		...
		try {
			const response = await nextWordPrediction(trimmedInput, maxTokens);
			const newWords = response.replace(trimmedInput, "").trim().split(" ");

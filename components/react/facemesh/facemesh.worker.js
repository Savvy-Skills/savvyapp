// This is a non-module worker script - No require/import statements allowed
// All code must be self-contained or loaded via importScripts()

// Load dependencies via CDN
importScripts(
  "https://cdn.jsdelivr.net/npm/@tensorflow/tfjs-core@2.4.0/dist/tf-core.min.js",
  "https://cdn.jsdelivr.net/npm/@tensorflow/tfjs-converter@2.4.0/dist/tf-converter.min.js",
  "https://cdn.jsdelivr.net/npm/@tensorflow/tfjs-backend-webgl@2.4.0/dist/tf-backend-webgl.min.js",
  "https://cdn.jsdelivr.net/npm/@tensorflow-models/face-landmarks-detection@0.0.1/dist/face-landmarks-detection.min.js",
  "https://cdn.jsdelivr.net/npm/@mediapipe/face_mesh@0.4.1633559619/face_mesh.js"
);

// Access libraries from the global scope
const tf = self.tf;
const faceLandmarksDetection = self.faceLandmarksDetection;

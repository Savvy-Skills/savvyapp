...
const sampleText = `
     This is [color:red]red text[/color].[size:20]This text is size 20.[/size] Here is an image: [img:https://placehold.co/150x150].This is the second line.\nAnd this is a new line.
  `;
...
const Introduction: React.FC<{ onStart: () => void }> = ({ onStart }) => (
	<View style={styles.container}>
		...
		{/* <RichTextRendererExample content={sampleText} /> */}
	</View>
);
